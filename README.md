...
<h3 align="center">Flash Cards</h3>
  ...
  <p align="center">
    A flash card game where you can learn French by guessing the French words right or wrong.
    <br />
    <br />
...
This python project allows user guess the French word and whether they guessed it right and wrong by using the flash card method.
 `putera-ilham`, `Flash-Cards`.
